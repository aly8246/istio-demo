...
//public class ExceptionHandlerAdvice3 {
...
//                e.getCause();
//                //获取result响应体
//                Result<?> result = JsonUtil.jsonToObject(ex.contentUTF8(), Result.class);
//
//                //获取原始的404结构
...
//        return new Result<>(e, SERVICE_NOT_UNAVAILABLE.getMsg(), serverExceptionResponse);
//    }
//
//}
